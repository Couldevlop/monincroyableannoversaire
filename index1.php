...
<div class="midicon"><a href="registetion.php">
<p>s'inscrire</p>
...
<?php for($i=0;$i<=20;$i++){?>
         leftrightslideuser[<?php echo $i; ?>]=' <?php while ($RecupCandJr = mysql_fetch_array($ExecutCandJr)) {
  ?><div class="midimgtag"><img src='<?php echo "photo/".$RecupCandJr['PHOTO']; ?>' width=54 height=52><p><?php echo $RecupCandJr['NOM_CANDIDAT']." ".substr($RecupCandJr['NUMERO'],3,8); ?><br><span>RANG: <?php echo $RecupCandJr['ID']; ?>e</span></p></div> <?php } ?>'
...
var finalslidethum=''
 <?php  $ExecutCandJr2 = mysql_query($SelectCandJr,$ConnexionBD); ?>


<?php for($i=0;$i<=20;$i++){?>
         leftrightslidethum[<?php echo $i; ?>]='<?php while ($RecupCandJr2 = mysql_fetch_array($ExecutCandJr2)) {
  ?><div class="midimgtag"><img src='<?php echo "photo/".$RecupCandJr2['PHOTO']; ?>' width=54 height=52><p><?php echo $RecupCandJr2['NOM_CANDIDAT']." ".substr($RecupCandJr2['NUMERO'],3,8); ?><br><span>RANG: <?php echo $RecupCandJr2['ID']; ?>e</span></p></div><?php } ?>'
      <?php } ?>
...
<img src="images/addimg3.jpg" height="408" >
...
<h1>Welcome</h1>
<iframe width="100%" height="250" src="//www.youtube.com/embed/gEr8M4XvQWE?feature=player_detailpage" frameborder="0" allowfullscreen></iframe></div>
...
<div class="fb-like-box" style="background:#FFF;" data-href="https://www.facebook.com/telcoannivafrik" data-width="100%"  data-height="256" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
...
<h1>News</h1>
<p><strong>RECUPERATION DE LOT DES VAINQUEURS DE LA SEMAINE</strong></p>

<span>Depuis le 01 Octobre 2014</span><br> 
La remise des lots DES GAGNANTS DE CHAQUE DEUX SEMAINES se fait les samedi en 15 a 15H a l'hotel EDA OBA DE LOME<br>


<div class="morebtn"><a href="#"><strong>more info</strong></a></div>
<div class="clear"></div>
</div>
...
<div class="mediaicon">
<a href="https://www.facebook.com/telcoannivafrik" target="_blank"><img src="images/facebook.png"></a>

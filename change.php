...
<div class="clear"></div>
<input type="password" id="name" name="nmdp" placeholder="Nouveau mot de passe" value="" class="form" />
<div class="clear"></div>
...
if (isset($_SESSION['lg']))
 { 
    ...
    ?>
<?php 
    if (isset($_SESSION['cpwd']))
     {
    ?>
    <?php 
      if ($_SESSION['cpwd'] == "non") 
    {echo ' <div align="left" style="font-size:17px"><font color="red"><strong>Vos informations sont incorrectes !!!</strong></font><p>&nbsp; </p></div>';
    // unset($_SESSION['cpwd']);
    }
     else  if($_SESSION['cpwd'] == "ok")
     {
        echo ' <div align="left" style="font-size:17px"><font color="green"><strong>Votre nouveau mot de passe a été envoyé a votre numero.</strong></font> <p>&nbsp; </p></div>';   
     } 
     
     ?>
      <?php  unset($_SESSION['cpwd']);}  ?> 
    <?php unset($_SESSION['lg']);} 
    else if ($_SESSION['lg'] == "non")
    { 

...
<div class="inqdropmain">
 <select name="Date" id="Date" class="inqdrop">
   ...
   <option value="0">Date</option>
    ...
    <div class="inqdropmain">
   <select name="Month" id="Month" class="inqdrop">
   ...
   <option value="0">Month</option>
    ...
    <div class="inqdropmain">
    <select name="Year" id="Year" class="inqdrop">
